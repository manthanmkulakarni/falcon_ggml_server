...
examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/train-text-from-scratch.cpp.o: /home/ubuntu/poc/ggllm.cpp/examples/train-text-from-scratch/train-text-from-scratch.cpp
examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/train-text-from-scratch.cpp.o: examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/ubuntu/poc/ggllm.cpp/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/train-text-from-scratch.cpp.o"
	cd /home/ubuntu/poc/ggllm.cpp/build/examples/train-text-from-scratch && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/train-text-from-scratch.cpp.o -MF CMakeFiles/train-text-from-scratch.dir/train-text-from-scratch.cpp.o.d -o CMakeFiles/train-text-from-scratch.dir/train-text-from-scratch.cpp.o -c /home/ubuntu/poc/ggllm.cpp/examples/train-text-from-scratch/train-text-from-scratch.cpp
...
examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/train-text-from-scratch.cpp.i: cmake_force
	...
	cd /home/ubuntu/poc/ggllm.cpp/build/examples/train-text-from-scratch && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/ubuntu/poc/ggllm.cpp/examples/train-text-from-scratch/train-text-from-scratch.cpp > CMakeFiles/train-text-from-scratch.dir/train-text-from-scratch.cpp.i
...
examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/train-text-from-scratch.cpp.s: cmake_force
	...
	cd /home/ubuntu/poc/ggllm.cpp/build/examples/train-text-from-scratch && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/ubuntu/poc/ggllm.cpp/examples/train-text-from-scratch/train-text-from-scratch.cpp -o CMakeFiles/train-text-from-scratch.dir/train-text-from-scratch.cpp.s
...
bin/train-text-from-scratch: /usr/local/cuda/lib64/libcudart.so
bin/train-text-from-scratch: /usr/local/cuda/lib64/libcublas.so
bin/train-text-from-scratch: /usr/local/cuda/lib64/libculibos.a
bin/train-text-from-scratch: /usr/local/cuda/lib64/libcublasLt.so
bin/train-text-from-scratch: examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/ubuntu/poc/ggllm.cpp/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/train-text-from-scratch"
	cd /home/ubuntu/poc/ggllm.cpp/build/examples/train-text-from-scratch && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/train-text-from-scratch.dir/link.txt --verbose=$(VERBOSE)
...
examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/clean:
	cd /home/ubuntu/poc/ggllm.cpp/build/examples/train-text-from-scratch && $(CMAKE_COMMAND) -P CMakeFiles/train-text-from-scratch.dir/cmake_clean.cmake
...
examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/depend:
	cd /home/ubuntu/poc/ggllm.cpp/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/ubuntu/poc/ggllm.cpp /home/ubuntu/poc/ggllm.cpp/examples/train-text-from-scratch /home/ubuntu/poc/ggllm.cpp/build /home/ubuntu/poc/ggllm.cpp/build/examples/train-text-from-scratch /home/ubuntu/poc/ggllm.cpp/build/examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/DependInfo.cmake --color=$(COLOR)
